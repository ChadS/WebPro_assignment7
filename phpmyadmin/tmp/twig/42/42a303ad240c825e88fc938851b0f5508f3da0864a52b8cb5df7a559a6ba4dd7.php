...
class __TwigTemplate_d3d5612aa8aca1fd02bf76f385d9e5ee5650e5c196dff683d20a685370e32505 extends Twig_Template
{
...
($context["content"] ?? null), "class" => "li_switch_dbstats", "url" => ["href" => ("server_databases.php" . PhpMyAdmin\Url::getCommon(["dbstats" => "1"])), "title" => _gettext("Enable statistics")]]];
            // line 78
            echo "    ";
            $this->loadTemplate("list/unordered.twig", "server/databases/databases_footer.twig", 78)->display(["items" => ($context["items"] ?? null)]);
        }
        // line 80
        echo "</form>
</div>
";
    ...
    {
        return new Twig_Source("", "server/databases/databases_footer.twig", "C:\\MAMP\\htdocs\\phpmyadmin\\templates\\server\\databases\\databases_footer.twig");
    }
}
